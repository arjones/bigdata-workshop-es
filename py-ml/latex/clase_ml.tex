...
\title[Intro ML Python]{Introducción Práctica a Machine Learning con Python}
\subtitle{Mutt - Claro}
\author[]{Mutt Data}
\institute[]{8 de Noviembre de 2019}
...
\section{Un poco de (necesario) contexto teórico}
...
\begin{frame}
  ...
  \begin{center}
    ...
    % \includegraphics[scale=0.2]{grid_search.png}
  \end{center}
\end{frame}
\begin{frame}
            ...
            \item Ejercicio 1: extracción de datos del hundimiento del Titanic
              \begin{enumerate}
                \item Escriba una función que obtenga, a partir de
                  \href{http://biostat.mc.vanderbilt.edu/wiki/pub/Main/DataSets/titanic3.csv}{este
                  enlace} y utilizando Pandas, el conjunto de datos de pasajeros
                  involucrados en el hundimiento del Titanic.
                ...
                \item Agregue lógica de cache para guardar una copia local del
                  conjunto de datos y evitar consultar repetidas veces el enlace
                  de arriba.
              \end{enumerate}
        \end{enumerate}
  \end{itemize}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[scale=0.7]{table_variables.pdf}
  \end{center}
  \begin{itemize}
      ...
      \begin{itemize}
        \item Ejercicio 2: Primer preproceso / EDA
          \begin{enumerate}
            ...
            \item ¿Tiene clases desbalanceadas? Haga un histograma para
