            ...
            \item \textit{Ejercicio 1: extracción de datos del hundimiento del Titanic}
              \begin{enumerate}
                \item Escriba una función que obtenga, a partir de
                  \href{https://gist.githubusercontent.com/petobens/29825af615da09752c2817e96732215a/raw/5ad193b26e8a2b79220028f0f1520a2d868ab28e/titanic.csv}{este enlace} y utilizando Pandas, el conjunto de datos de pasajeros
...
\begin{frame}[fragile=singleslide]
  \frametitle{Aun más EDA (y ejercicios)}
    ...
    \end{minted}
    \begin{center}
      \includegraphics[scale=0.1]{kde.png}
    \end{center}
  \begin{itemize}
